      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg md:text-xl">
            Discover the world's most breathtaking places loved by travelers
            worldwide
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {Populardestinations.map((dest, index) => (
            ...
            >
              {/* Gradient Background */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${dest.color} opacity-10 group-hover:opacity-20 transition-opacity duration-500`}
              ></div>
              ...
              <div className="relative h-48 md:h-56 overflow-hidden">
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${dest.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
                  ></div>
                </div>
              ...
              {/* Hover Effect Border */}
              <div
                className={`absolute inset-0 border-2 border-transparent group-hover:border-gradient-to-br ${dest.color} rounded-2xl opacity-0 group-hover:opacity-30 transition-opacity duration-500 pointer-events-none`}
              ></div>
            </div>
          ))}
        </div>
            ...
            {[
              ...
              >
                ...
                <div className="relative p-6 text-center">
                  <div
                    className={`w-14 h-14 mx-auto mb-4 rounded-full bg-gradient-to-br ${stat.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
