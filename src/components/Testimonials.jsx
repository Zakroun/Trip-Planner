...
export default function Testimonials() {
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Trusted by{" "}
            <span className="text-blue-500">Travelers Worldwide</span>
          </h2>

          <p className="text-gray-600 max-w-2xl mx-auto text-lg md:text-xl">
            Hear from real travelers who transformed their journeys with
            TripPlanner
          </p>
        </div>
        ...
        <div className="relative mb-20">
          ...
          {/* Testimonials Grid */}
          <div
            className={`grid grid-cols-1 lg:grid-cols-2 gap-8 transition-opacity duration-500 ${
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-16 h-16 rounded-full bg-gradient-to-br ${review.avatarColor} flex items-center justify-center text-white font-bold text-xl shadow-lg`}
                    >
              ...
              {[...Array(Math.ceil(reviews.length / 2))].map((_, i) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-300 ${
                    activeIndex === i * 2 ? "bg-blue-500 w-8" : "bg-gray-300"
                  }`}
                />
              ))}
            </div>
          ...
          <div className="relative z-10">
            <div className="text-center mb-10">
              ...
              <p className="text-blue-100 text-lg max-w-2xl mx-auto">
                Trusted by individuals, families, and travel professionals
                worldwide
              </p>
            </div>
